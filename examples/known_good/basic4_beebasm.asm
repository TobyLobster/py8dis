...
.c80a8
    ...
    ; Copy 11 bytes of memory from l80c2 to l0100
    ldx #&0a                                                          ; 80b4: a2 0a       ..
...
.loop_c91f6
    ; Copy Y bytes of memory from l0601
...
.sub_cbbeb
    ; Copy 16 bytes of memory from lbf72 to l07f0
    ldx #&10                                                          ; bbeb: a2 10       ..
...
.loop_cbc9d
    ; Copy Y bytes of memory from l0600
...
.loop_cbd19
    ; Copy Y bytes of memory to l0600
...
.cbf54
    ; Copy 10 bytes of memory from lb3be to l0600
    ldy #9                                                            ; bf54: a0 09       ..
...
; &bf71 referenced 1 time by &bbed
    equb &52                                                          ; bf71: 52          R
.lbf72
    equb &0b, &a8, &34, &a6, &e4, &a6, &0a, &a7, &10, &ad, &7e, &a5   ; bf72: 0b a8 34... ..4
    equb &4d, &a5, &4a, &2e, &7f, &5e, &5b, &d8, &aa,   0, &ca, &98   ; bf7e: 4d a5 4a... M.J
    equb &80, &81, &22, &f9, &83, &6e, &81, &49, &0f, &da, &a2, &21   ; bf8a: 80 81 22... .."
    equb &b3, &b2, &87, &80, &82, &38, &aa, &3b, &29, &80, &31, &72   ; bf96: b3 b2 87... ...
    equb &17, &f7, &d1, &5f, &5b, &e6, &ff, &66, &2b, &cc, &77, &6d   ; bfa2: 17 f7 d1... ...
    equb   6, &37, &bd, &73, &51, &b7, &17, &7a, &23, &d7, &0a, &81   ; bfae: 06 37 bd... .7.
    equb   0,   0,   0,   0, &82, &40,   0,   0,   0, &9a, &d4, &82   ; bfba: 00 00 00... ...
    equb &7f, &b9, &ff, &78, &7b, &0e, &fa, &35, &12, &86, &65, &2e   ; bfc6: 7f b9 ff... ...
    equb &e0, &d3, &7e, &88, &88, &88, &89, &7b, &8c                  ; bfd2: e0 d3 7e... ..~
