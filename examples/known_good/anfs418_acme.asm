...
sub_ca976
    ...
    !byte 8, $48, $8a, $48, $98, $48, $ba, $bd,   3, 1, $c9, 9, $b0   ; a97a: 08 48 8a... .H.
    !byte 4, $aa, $20, $93, $a9, $68, $a8, $68, $aa                   ; a987: 04 aa 20... ..
...
!if (l00aa - 1) != $a9 {
    !error "Assertion failed: l00aa - 1 == $a9"
}
!if (l00be - 1) != $bd {
    !error "Assertion failed: l00be - 1 == $bd"
}
!if (l00ee - 1) != $ed {
    !error "Assertion failed: l00ee - 1 == $ed"
}
!if (l0601 - 1) != $0600 {
    !error "Assertion failed: l0601 - 1 == $0600"
}
!if (l0d00 - 1) != $0cff {
...
!if (sub_cbd95 - 1) != $bd94 {
    !error "Assertion failed: sub_cbd95 - 1 == $bd94"
}
