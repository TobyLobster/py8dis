...
* = $3001
    ...
    .asc " !", 34, "#$%&'()*+,-.", $2f, "0123456789:;<=>?@ABCDEFGHIJ" // 3020: 20 21 22...  !" :301f[1]
    .asc "KLMNOPQRSTUVWXYZ[", 92, "]", 94, "_`abcdefghijklmnopqrstuv" // 304b: 4b 4c 4d... KLM :304a[1]
    .asc "wxyz{|}~"                                                   // 3077: 77 78 79... wxy :3076[1]
