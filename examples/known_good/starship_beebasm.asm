...
.bit_table
    equb &80, &40, &20, &10, 8, 4, 2, 1                               ; 1f41: 80 40 20... .@  :0e41[1]   ; bitmask
...
; ----------------------------------------------------------------------------------
.sound_4
    equb &12, 0, 2, 0, &c0, 0, &1f, 0                                 ; 32e0: 12 00 02... ... :21e0[1]   ; Channel (2 bytes); Amplitude (2 bytes); Pitch (2 bytes); Duration (2 bytes)
; ----------------------------------------------------------------------------------
...
.emotions
    ...
    equs "disappointed", '"', "satisfied", '"', "pleased", '"', "imp" ; 4be7: 64 69 73... dis :3ae7[1]
    equs "ressed", '"', "delighted", '"'                              ; 4c09: 72 65 73... res :3b09[1]
...
.instructions_string
    ...
    equs "All the above may operate simultaneouslyAlternatively , ON" ; 4f5b: 41 6c 6c... All :3e5b[1]
    equs "E of the following maybe depressed...."                     ; 4f95: 45 20 6f... E o :3e95[1]
...
.starfleet_records_string
    ...
    equs "Below is a list of the most highly ratedof Star-Fleet's pa" ; 53c7: 42 65 6c... Bel :42c7[1]
    equs "st commanders."                                             ; 5401: 73 74 20... st  :4301[1]
...
.the_frontiers_string
    ...
    equs "  The frontiers of space are frequently penetrated  by  ho" ; 5796: 20 20 54...   T :4696[1]
    equs "stile  alien  ships .  These are tackled by battle starshi" ; 57d0: 73 74 69... sti :46d0[1]
    equs "ps ,the  command  of  which  is  given  to  deserving capt" ; 580a: 70 73 20... ps  :470a[1]
    equs "ains from the Star-Fleet ."                                 ; 5844: 61 69 6e... ain :4744[1]
