...
; ----------------------------------------------------------------------------------
sound_4
    !byte $12, 0, 2, 0, $c0, 0, $1f, 0                                ; 32e0: 12 00 02... ... :21e0[1]   ; Channel (2 bytes); Amplitude (2 bytes); Pitch (2 bytes); Duration (2 bytes)
; ----------------------------------------------------------------------------------
...
emotions
    ...
    !text "disappointed", '"', "satisfied", '"', "pleased", '"', "im" ; 4be7: 64 69 73... dis :3ae7[1]
    !text "pressed", '"', "delighted", '"'                            ; 4c08: 70 72 65... pre :3b08[1]
...
instructions_string
    ...
    !text "All the above may operate simultaneouslyAlternatively , O" ; 4f5b: 41 6c 6c... All :3e5b[1]
    !text "NE of the following maybe depressed...."                   ; 4f94: 4e 45 20... NE  :3e94[1]
...
starfleet_records_string
    ...
    !text "Below is a list of the most highly ratedof Star-Fleet's p" ; 53c7: 42 65 6c... Bel :42c7[1]
    !text "ast commanders."                                           ; 5400: 61 73 74... ast :4300[1]
...
the_frontiers_string
    ...
    !text "  The frontiers of space are frequently penetrated  by  h" ; 5796: 20 20 54...   T :4696[1]
    !text "ostile  alien  ships .  These are tackled by battle stars" ; 57cf: 6f 73 74... ost :46cf[1]
    !text "hips ,the  command  of  which  is  given  to  deserving c" ; 5808: 68 69 70... hip :4708[1]
    !text "aptains from the Star-Fleet ."                             ; 5841: 61 70 74... apt :4741[1]
