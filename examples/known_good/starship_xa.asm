...
bit_table
    .byt $80, $40, $20, $10, 8, 4, 2, 1                               // 1f41: 80 40 20... .@  :0e41[1]   // bitmask
...
emotions
    .asc "", 34, "furious", 34, "displeased", 34, "disappointed"      // 4bc6: 22 66 75... "fu :3ac6[1]
    .asc "", 34, "disappointed", 34, "satisfied", 34, "pleased"       // 4be6: 22 64 69... "di :3ae6[1]
    .asc "", 34, "impressed", 34, "delighted", 34, ""                 // 4c05: 22 69 6d... "im :3b05[1]
...
instructions_string
    ...
    .asc "All the above may operate simultaneouslyAlternatively , ON" // 4f5b: 41 6c 6c... All :3e5b[1]
    .asc "E of the following maybe depressed...."                     // 4f95: 45 20 6f... E o :3e95[1]
...
starfleet_records_string
    ...
    .asc "Below is a list of the most highly ratedof Star-Fleet's pa" // 53c7: 42 65 6c... Bel :42c7[1]
    .asc "st commanders."                                             // 5401: 73 74 20... st  :4301[1]
...
the_frontiers_string
    ...
    .asc "  The frontiers of space are frequently penetrated  by  ho" // 5796: 20 20 54...   T :4696[1]
    .asc "stile  alien  ships .  These are tackled by battle starshi" // 57d0: 73 74 69... sti :46d0[1]
    .asc "ps ,the  command  of  which  is  given  to  deserving capt" // 580a: 70 73 20... ps  :470a[1]
    .asc "ains from the Star-Fleet ."                                 // 5844: 61 69 6e... ain :4744[1]
